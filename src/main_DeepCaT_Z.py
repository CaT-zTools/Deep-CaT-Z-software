...
"")
    ...
    def stop_pb_CLICKED(self):
        ...
        for id in len(array_timesteps_tosave):
            array_timesteps_tosave[id] = round(array_timesteps_tosave[id], 1)
        ...
        if self.allGood_arduino_connected & self.allGood_arduino_streaming:
            list_outputs_arduino_tosave = np.array(self.list_outputs_arduino).reshape((-1,8))
